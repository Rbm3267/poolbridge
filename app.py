...
with st.sidebar:
    ...
    crs_options = {
        ...
        "UTM Zone 13N — west TX / NM": "EPSG:32613",
        "UTM Zone 14N — central TX": "EPSG:32614",
        "UTM Zone 15N — east TX / LA": "EPSG:32615",
        "TX State Plane North (US ft)": "EPSG:2275",
        "TX State Plane North Central (US ft)": "EPSG:2276",
        "TX State Plane Central (US ft)": "EPSG:2277",
        "TX State Plane S. Central (US ft)": "EPSG:2278",
        "TX State Plane South (US ft)": "EPSG:2279",
        "LA State Plane North (US ft)": "EPSG:3451",
        "LA State Plane South (US ft)": "EPSG:3452",
        # --- Southeast ---
        "UTM Zone 16N — AL, MS, TN, KY, W. GA": "EPSG:32616",
        "UTM Zone 17N — FL, GA, SC, NC, VA (central)": "EPSG:32617",
        "UTM Zone 18N — NC, VA (coast)": "EPSG:32618",
        "AL State Plane East (US ft)": "EPSG:2254",
        "AL State Plane West (US ft)": "EPSG:2255",
        "MS State Plane East (US ft)": "EPSG:2254",
        "MS State Plane West (US ft)": "EPSG:2255",
        "TN State Plane (US ft)": "EPSG:2274",
        ...
        # --- Mid-Atlantic ---
        "UTM Zone 18N — Mid-Atlantic / New England": "EPSG:32618",
        "UTM Zone 19N — Maine / Maritime New England": "EPSG:32619",
        "NY State Plane East (US ft)": "EPSG:2261",
        "NY State Plane Central (US ft)": "EPSG:2262",
        "NY State Plane West (US ft)": "EPSG:2263",
        "NY State Plane Long Island (US ft)": "EPSG:2263",
        "PA State Plane North (US ft)": "EPSG:2271",
        "PA State Plane South (US ft)": "EPSG:2272",
        "NJ State Plane (US ft)": "EPSG:3424",
        "MD State Plane (US ft)": "EPSG:2248",
        "DE State Plane (US ft)": "EPSG:2235",
        # --- New England ---
        "MA State Plane Mainland (US ft)": "EPSG:2249",
        "MA State Plane Islands (US ft)": "EPSG:2250",
        "CT State Plane (US ft)": "EPSG:2234",
        "RI State Plane (US ft)": "EPSG:3438",
        "VT State Plane (US ft)": "EPSG:32145",
        "NH State Plane (US ft)": "EPSG:3437",
        "ME State Plane East (US ft)": "EPSG:26883",
        "ME State Plane West (US ft)": "EPSG:26884",
        # --- Midwest ---
        "UTM Zone 15N — MN, WI, IA, MO (west)": "EPSG:32615",
        "UTM Zone 16N — IL, IN, OH, MI, WI (east)": "EPSG:32616",
        "IL State Plane East (US ft)": "EPSG:3435",
        "IL State Plane West (US ft)": "EPSG:3436",
        "IN State Plane East (US ft)": "EPSG:2965",
        "IN State Plane West (US ft)": "EPSG:2966",
        "OH State Plane North (US ft)": "EPSG:3734",
        "OH State Plane South (US ft)": "EPSG:3735",
        "MI State Plane South (US ft)": "EPSG:6498",
        "MI State Plane Central (US ft)": "EPSG:6496",
        "MI State Plane North (US ft)": "EPSG:6494",
        "WI State Plane North (US ft)": "EPSG:2287",
        "WI State Plane Central (US ft)": "EPSG:2289",
        "WI State Plane South (US ft)": "EPSG:2288",
        "MN State Plane North (US ft)": "EPSG:26848",
        "MN State Plane Central (US ft)": "EPSG:26849",
        "MN State Plane South (US ft)": "EPSG:26850",
        "MO State Plane East (US ft)": "EPSG:2815",
        "MO State Plane Central (US ft)": "EPSG:2816",
        "MO State Plane West (US ft)": "EPSG:2817",
        "KS State Plane North (US ft)": "EPSG:3419",
        "KS State Plane South (US ft)": "EPSG:3420",
        # --- Mountain West ---
        "UTM Zone 12N — AZ, UT, CO (west)": "EPSG:32612",
        "UTM Zone 13N — NM, CO, WY, MT (east)": "EPSG:32613",
        "CO State Plane North (US ft)": "EPSG:2231",
        "CO State Plane Central (US ft)": "EPSG:2232",
        "CO State Plane South (US ft)": "EPSG:2233",
        "AZ State Plane East (US ft)": "EPSG:2222",
        "AZ State Plane Central (US ft)": "EPSG:2223",
        "AZ State Plane West (US ft)": "EPSG:2224",
        "NM State Plane East (US ft)": "EPSG:2257",
        "NM State Plane Central (US ft)": "EPSG:2258",
        "NM State Plane West (US ft)": "EPSG:2259",
        "UT State Plane North (US ft)": "EPSG:3560",
        "UT State Plane Central (US ft)": "EPSG:3566",
        "UT State Plane South (US ft)": "EPSG:3567",
        "NV State Plane East (US ft)": "EPSG:3421",
        "NV State Plane Central (US ft)": "EPSG:3422",
        "NV State Plane West (US ft)": "EPSG:3423",
        "ID State Plane East (US ft)": "EPSG:2241",
        "ID State Plane Central (US ft)": "EPSG:2242",
        "ID State Plane West (US ft)": "EPSG:2243",
        "MT State Plane (US ft)": "EPSG:2256",
        "WY State Plane East (US ft)": "EPSG:3736",
        "WY State Plane E. Central (US ft)": "EPSG:3737",
        "WY State Plane W. Central (US ft)": "EPSG:3738",
        "WY State Plane West (US ft)": "EPSG:3739",
        # --- Pacific Northwest ---
        "UTM Zone 10N — WA, OR (coast / west)": "EPSG:32610",
        "UTM Zone 11N — WA, OR, ID, NV (east)": "EPSG:32611",
        "WA State Plane North (US ft)": "EPSG:2926",
        "WA State Plane South (US ft)": "EPSG:2927",
        "OR State Plane North (US ft)": "EPSG:2913",
        "OR State Plane South (US ft)": "EPSG:2914",
        # --- California ---
        "UTM Zone 10N — CA (coast / north)": "EPSG:32610",
        "UTM Zone 11N — CA (central / south)": "EPSG:32611",
        "CA State Plane Zone I (US ft)": "EPSG:2225",
        "CA State Plane Zone II (US ft)": "EPSG:2226",
        "CA State Plane Zone III (US ft)": "EPSG:2227",
        "CA State Plane Zone IV (US ft)": "EPSG:2228",
        "CA State Plane Zone V (US ft)": "EPSG:2229",
        "CA State Plane Zone VI (US ft)": "EPSG:2230",
        # --- Custom ---
        "Custom EPSG…": "custom",
    }
